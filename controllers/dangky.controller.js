...
// Tính tổng số Khoá Học và số Khoá Học Học Viên đã hoàn thành
...
exports.registerStudentToCourse = async (req, res) => {
    try {
        ...
        if (rows[0].total === 0) {
            return res.status(400).json({ error: 'Khóa học này chưa có nội dung bài học, không thể đăng ký.' });
        }
...
// Lấy danh sách Học Viên trong Khoá Học
...
// Lấy danh sách Khoá Học của Học Viên
